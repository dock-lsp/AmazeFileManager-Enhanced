...
- **🎬 Built-in Media Player** - Play videos and music with gesture controls
- **🎨 Image Editor** - Crop, rotate, apply filters and annotate images
- **📄 PDF Tools** - View, annotate, merge, split and convert PDFs
- **📝 Enhanced Code Editor** - Syntax highlighting, Git integration, code folding
- **💻 Terminal Emulator** - Multi-tab terminal with root support
